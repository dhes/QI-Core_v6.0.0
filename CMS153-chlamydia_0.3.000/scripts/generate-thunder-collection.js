...
const OUTPUT_FILE = path.join(__dirname, "..","..", "thunder-tests", "collections", "tc_col_CMS153-chlamydia_0.3.000.json");

const MEASURE_ID = "CMS153FHIRChlamydiaScreeninginWomen";
...
function getThunderClientCollection() {
  ...
  const collection = {
    _id: colId,
    colName: "CMS153-chlamydia_0.3.000",
