...
const OUTPUT_FILE = path.join(__dirname, "..","..", "thunder-tests", "collections", "tc_col_CMS139-falls_0.4.000.json");

const MEASURE_ID = "CMS139FHIRFallsScreeningForFutureFallRisk";
