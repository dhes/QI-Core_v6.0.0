...
const OUTPUT_FILE = path.join(__dirname, "..","..", "thunder-tests", "collections", "tc_col_CMS349-hiv_0.3.000-v2.json");
        ...
        inlineScripts: [
          {
            script: [
              ...
              `tc.test("Denominator Exception = ${popCounts["denominator-exception"] ?? 0}", getPopCount("denominator-exception") === ${popCounts["denominator-exception"] ?? 0});`,
