...
const TEST_CASES_DIR = path.join(__dirname, "CMS125-breast_0.2.000", "test-cases");
const OUTPUT_FILE = path.join(__dirname, "thunder-tests", "collections", "tc_col_cms-breast0.2.000.json");

const MEASURE_ID = "CMS125FHIRBreastCancerScreening";
