...
const OUTPUT_FILE = path.join(__dirname, "..","..", "thunder-tests", "collections", "tc_col_cms131-eye0.2.000.json");

const MEASURE_ID = "CMS131FHIRDiabetesEyeExam";
